...
function s.thfilter(c)
	return c:IsSetCard(0xde3) and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsAbleToHand()
end
...
function s.spfilterGY(c,e,tp)
	return c:IsCode(300004) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
