--Twin Bell Heavy Metal Hedgehog
local s,id,o=GetID()
function s.initial_effect(c)
	--special summon Metal Hedgehog
...
function s.spfilter(c,e,tp)
	return c:IsCode(143300007) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(aux.TRUE,tp,0,LOCATION_SZONE+LOCATION_FZONE,1,nil) end
	local g=Duel.GetMatchingGroup(aux.TRUE,tp,0,LOCATION_SZONE+LOCATION_FZONE,nil)
